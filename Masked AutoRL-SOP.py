...
# Path to dataset (Update this path based on your environment)
BASE_PATH = "./SOP_Datasets"
...
class SOPEnv:
    def __init__(self, distance_matrix, precedences, epsilon, alpha, gamma, n_training_eps, problem_name="SOP", target_solution=0):
        ...
        # self.unlocks[a] contains list of nodes that 'a' unlocks
    ...
    def render(self, window=100):
        ...
        plt.title(f'Final Masked AutoRL-SOP Training - {self.problem_name}', fontsize=18)
        ...
        plt.savefig(f'{self.problem_name}.pdf', format='pdf', bbox_inches='tight')
        plt.show()
...
if __name__ == "__main__":
    ...
    db_name = f"optuna_results_{key_name}.db"
