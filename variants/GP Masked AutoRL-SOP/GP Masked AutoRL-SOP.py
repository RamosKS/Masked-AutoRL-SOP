"""Masked AutoRL-SOP using Gaussian Process Bayesian optimization."""
...
class SOPEnv:
    ...
    def render(self, window=100):
        ...
        plt.title(f'Final GP Masked AutoRL-SOP Training - {self.problem_name}', fontsize=18)
...
if __name__ == "__main__":
    ...
    print(f"\nStarting GP (Gaussian Process) Optimization (Single Seed: {SEED_VALUE})...")
